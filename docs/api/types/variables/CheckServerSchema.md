...
[health-monitor-mcp](../../README.md) / [types](../README.md) / CheckServerSchema

# Variable: CheckServerSchema
...
Defined in: [types.ts:104](https://github.com/oaslananka/health-monitor-mcp/blob/main/src/types.ts#L104)
