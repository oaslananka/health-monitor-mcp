...
[health-monitor-mcp](../../README.md) / [types](../README.md) / GetUptimeSchema

# Variable: GetUptimeSchema
...
Defined in: [types.ts:118](https://github.com/oaslananka/health-monitor-mcp/blob/main/src/types.ts#L118)
