...
Defined in: [app.ts:80](https://github.com/oaslananka/health-monitor-mcp/blob/main/src/app.ts#L80)
...
Defined in: [app.ts:81](https://github.com/oaslananka/health-monitor-mcp/blob/main/src/app.ts#L81)
