...
export const REMEDIATIONS = {
  ...
  PIPELINE_NOT_RESOLVED:
    'Ensure the pipeline ID is correct or allow time for background resolution.',
  NO_RECENT_BUILDS: 'Trigger a build in Azure DevOps to generate telemetry data.',
  STDIO_DISABLED:
    'Enable stdio support by setting HEALTH_MONITOR_ENABLE_STDIO=1 in your environment.'
} as const;
